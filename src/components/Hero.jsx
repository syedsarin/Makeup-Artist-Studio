...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative sm:min-h-[90vh] pt-16 pb-10 sm:pt-24 sm:pb-16 lg:pt-32 lg:pb-24 overflow-hidden flex items-start sm:items-center bg-[#FAF8F5]">
      {/* Background Glow */}
