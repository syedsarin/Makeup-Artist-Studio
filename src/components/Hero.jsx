...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative sm:min-h-[90vh] pt-24 pb-10 sm:pt-28 sm:pb-16 lg:pt-36 lg:pb-24 overflow-hidden flex items-start sm:items-center bg-[#FAF8F5]">
      {/* Background Glow */}
